...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, objects, depth, alpha, radii, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        return color, radii, objects, depth, alpha

    @staticmethod
    def backward(ctx, grad_color, grad_radii, grad_out_objects, grad_depth, grad_alpha):
