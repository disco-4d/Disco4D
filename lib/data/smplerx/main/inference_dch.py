...
def infer_dch(img_path, output_folder):
    ...
    config_path = osp.join('lib/data/smplerx/main/config', f'config_{args_pretrained_model}.py')
    ckpt_path = osp.join('lib/data/smplerx/pretrained_models', f'{args_pretrained_model}.pth.tar')
    ...
    checkpoint_file = 'lib/data/smplerx/pretrained_models/mmdet/faster_rcnn_r50_fpn_1x_coco_20200130-047c8118.pth'
    # config_file= './mmpose/pretrained_models/mmdet/mmdet_faster_rcnn_r50_fpn_coco.py'
    config_file= 'lib/data/mmpose/demo/mmdetection_cfg/faster_rcnn_r50_fpn_coco.py'
