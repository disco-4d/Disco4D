...
encoder_config_file = 'lib/data/smplerx/main/transformer_utils/configs/smpler_x/encoder/body_encoder_huge_updated.py'
encoder_pretrained_model_path = 'lib/data/smplerx/pretrained_models/vitpose_huge.pth'
feat_dim = 1280
