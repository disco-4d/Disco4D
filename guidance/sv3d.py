...
def build_sv3d_model(num_steps,
    ...
    model_config = "configs/sv3d_p.yaml"
...
def load_model(
    ...
    assert os.path.exists(config.model.params.ckpt_path), f"Model checkpoint not found at {config.model.params.ckpt_path}, please download it from https://huggingface.co/stabilityai/sv3d/tree/main"
