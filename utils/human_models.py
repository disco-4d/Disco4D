...
class SMPLX(object):
    def __init__(self):
        ...
        self.layer = {'neutral': smplx.create(human_model_path, 'smplx', gender='NEUTRAL', use_pca=False, use_face_contour=True, flat_hand_mean=False, **self.layer_arg),
                        'male': smplx.create(human_model_path, 'smplx', gender='MALE', use_pca=False, use_face_contour=True, flat_hand_mean=True, **self.layer_arg),
